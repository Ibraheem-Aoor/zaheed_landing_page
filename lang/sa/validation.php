...
return [
    ...
    'iban' => 'الإيبان يجب ان يكون رقم بنكي صالح',
    ...
    */
    ...
    'attributes' => [
        ...
        'Name' => 'الإسم',
        'remember' => 'تذكرني',
        'password_confirmation' => 'إعادة كلمو المرور',
        'agree_service' => 'قبول سياسة الخصوصية',
        'culture_ar' => 'الثقافة بالعربيّة',
        'culture_en' => 'الثقافة بالإنجليزيّة',
        'role_ar' => 'الدور بالعربيّة',
        'role_en' => 'الدور بالإنجليزيّة',
        'role_id' => 'الدور',
        'token' => 'رقم التشفير',
        'web_img' => 'صورة الويب',
        ...
        'location_url' => 'رابط الموقع على الخربطة',
        'message' => 'الرسالة',
    ],
