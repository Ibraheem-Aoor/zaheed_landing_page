          ...
          <div class="content-form-footer" id="contact">
            <form class="custom-form" action="{{ route('contact.submit') }}" method="POST">
              ...
              <div class="all-input-fails-footer">
                <input name="name" type="text" placeholder="{{ __('general.footer.name_placeholder') }}" />
              </div>
              <div class="all-input-fails-footer">
                <input name="email" type="text" placeholder="{{ __('general.footer.email_placeholder') }}" />
              </div>
              <div class="all-input-fails-footer">
                <textarea name="message" placeholder="{{ __('general.footer.message_placeholder') }}"></textarea>
              </div>
              <div class="but-all-form">
                <button class="button2" type="submit">{{ __('general.footer.contact_button') }}</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="col-sm-12 col-md-4 col-lg-4">
        <div class="foot-content">
          ...
          <div class="link-page">
            ...
            @auth<a href="{{ route('showDeleteAccount') }}">{{ __('general.footer.delete_account') }}</a>@endauth
          </div>
        </div>
      </div>
    </div>
