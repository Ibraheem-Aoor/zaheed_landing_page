...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/style.css') }}?v=0.02" />
    <link rel="stylesheet" href="{{ asset('assets/css/step.css') }}?v=0.02" />
    {{-- arabic css --}}
    <link rel="stylesheet" href="{{ asset('assets/css/media.css') }}?v=0.02" />
    @if (app()->getLocale() == 'sa')
        <link rel="stylesheet" href="{{ asset('assets/css/style-arbic.css') }}?v=0.02" />
        <link rel="stylesheet" href="{{ asset('assets/css/media-arbic.css') }}?v=0.02"> @endif
    <link rel="stylesheet"
