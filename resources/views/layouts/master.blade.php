...
<head>
    ...
    {{-- arabic css --}}
    <link rel="stylesheet" href="{{ asset('assets/css/media.css') }}?v=0.03" />
    @if (app()->getLocale() == 'sa')
        <link rel="stylesheet" href="{{ asset('assets/css/style-arbic.css') }}?v=0.03" />
        <link rel="stylesheet" href="{{ asset('assets/css/media-arbic.css') }}?v=0.03"> @endif
    <link rel="stylesheet"
