                        ...
                        <div class="form-partner">
                            ...
                            <div class="all-input-failds-partner">
                                ...
                                <input required type="text"
                                    placeholder="{{ __('general.partner_registration.store_name_arabic') }}"
                            ...
                            <div class="all-input-failds-partner">
                                ...
                                <input type="number" placeholder="{{ __('general.partner_registration.enter_number') }}"
                    ...
                    <fieldset id="fieldset-step-2">
                        ...
                        <div class="form-partner">
                            ...
                            <div class="all-input-failds-partner">
                                ...
                                <select class="form-select js-example-disabled-results" style="width: 100% !important"
                                    aria-label="{{ __('general.partner_registration.bank_name') }}" name="bank_id">
                            ...
                            <div class="all-input-failds-partner">
                                ...
                                <input type="text" placeholder="{{ __('general.partner_registration.enter_iban') }}"
                                    name="iban" id="iban_input" />
                            </div>
                            ...
                            <div class="all-input-failds-partner">
                                <label for=""
                                    class="lab-tst">{{ __('general.partner_registration.contact_name') }}
                                    <span>*</span></label>
                                <input required type="text"
                                    placeholder="{{ __('general.partner_registration.enter_contact_name') }}"
                                    name="name" />
                            </div>
                            <div class="all-input-failds-partner">
                            ...
                            <div class="content-upload-image-Partner">
                                ...
                                <div class="box-upload-image-company">
                                    ...
                                    <div onclick="UploadImageOneFun();" class="square-upload-image">
                                        ...
                                        <input required type="file" accept="jpg,png,web,jpeg" id="uploadImageOne"
            ...
            inputElements.each(function() {
                ...
                if ($(this).attr('required')) {
                    ...
                    if (($(this).val() === '' || ($(this).is('[type="file"]') && !$(this).prop('files').length))) {
                        ...
                        if (!$(this).val().match(/^[\w.%+-]+@(?!(?:example\.com|test\.com)$)[a-zA-Z\d.-]+\.[a-zA-Z]{2,}$/)) {
                            isValid = false;
