...
class DigecoTheme_Address_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct(
            'digeco_address', // Base ID
            esc_html__( 'Digeco : Address (for footer)', 'digeco-core' ), // Name
            array( 'description' => esc_html__( 'Address Widget', 'digeco-core' ) ) // Args
            );
	}
	...
	public function form( $instance ){
		$defaults = array(
			'title'   		=> esc_html__( 'Corporate Office' , 'digeco-core' ),
			'description'	=> '',
			'address'		=> '',
			'phone'   		=> '',
			'email'   		=> '',
		...
		$fields = array(
			...
			'phone'     => array(
				'label' => esc_html__( 'Phone Number', 'digeco-core' ),
				'type'  => 'text',
			),      
			'email'     => array(
