<?php
/*
Plugin Name: Digeco Core
Plugin URI: https://www.radiustheme.com
Description: Digeco Core Plugin for Digeco Theme
Version: 1.7.0
Author: RadiusTheme
...
if ( ! defined( 'DIGECO_CORE' ) ) {
	define( 'DIGECO_CORE',                   ( WP_DEBUG ) ? time() : '1.0' );
	define( 'DIGECO_CORE_THEME_PREFIX',      'digeco' );
	define( 'DIGECO_CORE_THEME_PREFIX_VAR',  'digeco' );
	define( 'DIGECO_CORE_CPT_PREFIX',        'digeco' );
	define( 'DIGECO_CORE_BASE_DIR',      plugin_dir_path( __FILE__ ) );
}

class Digeco_Core {

	public $plugin  = 'digeco-core';
	public $action  = 'digeco_theme_init';

	public function __construct() {
		$prefix = DIGECO_CORE_THEME_PREFIX_VAR;
		...
		add_action( 'redux/loaded', array( $this, 'digeco_remove_demo') );
	...
	*/
	...
	public function digeco_remove_demo() {
	...
	public function after_theme_loaded() {
		require_once DIGECO_CORE_BASE_DIR . 'lib/wp-svg/init.php'; // SVG support
