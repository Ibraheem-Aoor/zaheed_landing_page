...
<div class="default-testimonial rtin-testimonial-9 <?php echo esc_attr( $data['nav_style'] );?> <?php echo esc_attr( $data['nav_position'] );?> owl-wrap <?php echo esc_attr( $slider_nav_class ); ?><?php echo esc_attr( $slider_dot_class ); ?>">
