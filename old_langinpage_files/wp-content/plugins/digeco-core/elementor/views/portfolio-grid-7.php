...
<div class="<?php if ( $data['animation_display'] == 'yes' ) { ?>has-animation<?php } else { ?>no-animation<?php } ?>">
	<div class="portfolio-default portfolio-grid-<?php echo esc_attr( $data['layout'] );?>">
		<div class="row <?php echo esc_attr( $gap_class ); ?> portfolio-grid-items">	
			<?php  $k = 1; $j = $data['delay'];
				if ( $query->have_posts() ) {
