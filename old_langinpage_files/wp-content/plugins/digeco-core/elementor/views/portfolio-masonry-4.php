...
$thumb_size = 'digeco-size' . rand( 7, 8 ) ;
...
?>
<div class="portfolio-default portfolio-multi-layout-4 portfolio-masonry-<?php echo esc_attr( $data['layout'] );?> <?php if ( $data['all_button'] == 'hide' ) {?>hide-all<?php } ?> rt-isotope-wrapper">
					...
					<a href="<?php the_permalink(); ?>">
						<?php
							if ( has_post_thumbnail() ){
								the_post_thumbnail( ('digeco-size' . rand( 7, 8 ) ) , ['class' => 'img-fluid mb-10 width-100'] );
							} else {
								if ( !empty( DigecoTheme::$options['no_preview_image']['id'] ) ) {
									echo wp_get_attachment_image( DigecoTheme::$options['no_preview_image']['id'], ('digeco-size' . rand( 7, 8 ) ) );
								} else {
