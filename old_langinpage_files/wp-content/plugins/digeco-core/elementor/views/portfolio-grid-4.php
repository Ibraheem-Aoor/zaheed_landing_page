...
<div class="<?php if ( $data['animation_display'] == 'yes' ) { ?>has-animation<?php } else { ?>no-animation<?php } ?>">
	<div class="portfolio-default portfolio-multi-layout-3 portfolio-grid-<?php echo esc_attr( $data['layout'] );?>">
				...
				<div class="translate-bottom-75 opacity-animation transition-150 transition-delay-<?php echo esc_attr( $j );?>">
					<div class="rtin-item">
						<div class="rtin-figure">
							...
							<div class="rtin-icon"><a href="<?php the_permalink(); ?>"><i class="fas fa-plus"></i></a></div>
						</div>
