...
<div class="<?php echo esc_attr( $data['animation_display'] ); ?>">
	<div class="translate-bottom-75 opacity-animation transition-150 transition-delay-<?php echo esc_attr( $data['delay'] );?>">
		<div class="info-box-default info-box-<?php echo esc_attr( $data['style'] );?>">
			<div class="icon-holder icon-bg-<?php echo esc_attr( $data['themestyle'] );?>">
				<div class="item-icon icon-color-<?php echo esc_attr( $data['themestyle'] );?>">
			...
			<?php switch ( $data['themestyle'] ) {
				...
				case 'hexagon': ?>
				<svg class="icon-bg-shape" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="59px" height="65px">
					<path d="M25.840,64.35 C26.947,64.666 28.213,64.999 29.499,64.999 C30.786,64.999 32.52,64.666 33.159,64.35 L55.340,51.395 C57.597,50.109 58.999,47.712 58.999,45.139 L58.999,19.860 C58.999,17.287 57.597,14.890 55.340,13.604 L33.159,0.964 C32.31,0.321 30.765,0.0 29.500,0.0 C28.234,0.0 26.969,0.321 25.840,0.964 L3.659,13.604 C1.402,14.890 0.0,17.287 0.0,19.860 L0.0,45.139 C0.0,47.712 1.402,50.109 3.659,51.395 L25.840,64.35 Z"/>
				</svg>
				<?php break;
