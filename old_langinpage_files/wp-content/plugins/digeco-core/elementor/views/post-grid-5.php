...
$digeco_has_entry_meta  = ( $data['post_grid_date'] == 'yes' || $data['post_grid_category'] == 'yes' || $data['post_grid_author'] == 'yes' || $data['post_grid_comment'] == 'yes' ) ? true : false;
					...
					<div class="translate-bottom-75 opacity-animation transition-150 transition-delay-<?php echo esc_attr( $i );?>">
						<div class="rtin-item">
							...
							<div class="rtin-content">
								...
								<a class="btn-ghost" href="<?php the_permalink();?>"><?php echo esc_html( $data['buttontext'] );?></a>
								<?php } ?>
							</div>
						</div>
					</div>
