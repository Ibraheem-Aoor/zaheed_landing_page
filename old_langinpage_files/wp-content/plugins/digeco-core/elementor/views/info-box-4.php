...
<div class="<?php echo esc_attr( $data['animation_display'] ); ?>">
	<div class="translate-bottom-75 opacity-animation transition-150 transition-delay-<?php echo esc_attr( $data['delay'] );?>">
		<div class="info-box-default info-box-<?php echo esc_attr( $data['style'] );?> <?php echo esc_attr( $data['theme_mode'] );?>">
			<div class="rtin-item rtin-<?php echo esc_attr( $data['icontype'] );?>" data-tilt >
