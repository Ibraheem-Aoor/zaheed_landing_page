...
<div class="rtel-content-toggle">
	<ul class="nav nav-tabs" data-id="myTab" role="tablist">
	  <li class="nav-item">
	    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#<?php echo esc_attr( $content_1_id ); ?>" role="tab" aria-controls="home-tab" aria-selected="true"><?php echo esc_html( $section_1_heading ); ?></a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#<?php echo esc_attr( $content_2_id ); ?>" role="tab" aria-controls="profile-tab" aria-selected="false"><?php echo esc_html( $section_2_heading ); ?></a>
	  </li>
	</ul>
