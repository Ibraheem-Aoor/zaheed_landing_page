...
if ( $data['button_style_two'] == 'digeco-button-1' ) {
	if ( !empty( $data['button_two'] ) ) {
		$btn2 = '<a class="btn-ghost" ' . $attr2 . '>' . $data['button_two'] . '</a>';
	}
} else if ( $data['button_style_two'] == 'digeco-button-2' ) {
	if ( !empty( $data['button_two'] ) ) {
		$btn2 = '<a class="btn-ghost btn-dark" ' . $attr2 . '>' . $data['button_two'] . '</a>';
	}
} else {
	if ( !empty( $data['button_two'] ) ) {
		$btn2 = '<a class="btn-ghost btn-ghost-gradient" ' . $attr2 . '>' . $data['button_two'] . '</a>';
	}
}
?>
