...
class RT_App extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT App Slider and Grid', 'digeco-core' );
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'id'      => 'layout',
				'label'   => esc_html__( 'App Layout', 'digeco-core' ),
				'options' => array(
					'layout1' => esc_html__( 'App Slider', 'digeco-core' ),
					'layout2' => esc_html__( 'App Grid', 'digeco-core' ),
				),
				'default' => 'layout1',
			),
			array(
			...
			array(
				...
				'id'      => 'apps',
				'label'   => esc_html__( 'Add as many apps as you want', 'digeco-core' ),
			...
			array(
				'type'        => Controls_Manager::SWITCHER,
				'id'          => 'is_center',
				'label'       => esc_html__( 'Slider Center', 'digeco-core' ),
				'label_on'    => esc_html__( 'On', 'digeco-core' ),
				'label_off'   => esc_html__( 'Off', 'digeco-core' ),
				'default'     => 'yes',
				'description' => esc_html__( 'Slider item center. Default: On', 'digeco-core' ),
			),
			array(
				'mode' => 'section_end',
			),
