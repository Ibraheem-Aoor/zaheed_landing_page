...
class Service_Grid extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Service Grid', 'digeco-core' );
	...
	public function rt_fields(){
		...
		$terms  = get_terms( array( 'taxonomy' => 'digeco_service_category', 'fields' => 'id=>name' ) );
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'layout1' => esc_html__( 'Service 1', 'digeco-core' ),
					'layout2' => esc_html__( 'Service 2', 'digeco-core' ),
					'layout3' => esc_html__( 'Service 3', 'digeco-core' ),
				),
				'default' => 'layout1',
			),
			array (
			...
			array (
				...
				'id'      => 'read_more_text',
				'label'   => esc_html__( 'Read More', 'digeco-core' ),
			...
			array (
				...
				'label'   => esc_html__( 'Item Title Hover Color', 'digeco-core' ),
				'default' => '',
				'selectors' => array(
			...
			array (
				...
				'default' => esc_html__( 'All Services', 'digeco-core' ),
			),
			array (
				'type'    => Controls_Manager::TEXT,
				'id'      => 'see_button_link',
