...
class Portfolio_Isotope extends Custom_Widget_Base {

	public function __construct( $data = [], $args = null ){
		$this->rt_name = esc_html__( 'RT Portfolio Isotope', 'digeco-core' );
		$this->rt_base = 'rt-portfolio-isotope';
	...
	public function rt_fields(){
		...
		$fields = array(
			...
			array(
				...
				'options' => array(
					'layout1' => esc_html__( 'Isotope layout 1', 'digeco-core' ),
					'layout2' => esc_html__( 'Isotope layout 2', 'digeco-core' ),
					'layout3' => esc_html__( 'Isotope layout 3', 'digeco-core' ),
					'layout4' => esc_html__( 'Isotope layout 4', 'digeco-core' ),
				),
				'default' => 'layout1',
			),			
	...
	protected function render() {
		...
		switch ( $data['layout'] ) {
			case 'layout4':
			$template = 'portfolio-isotope-4';
			break;
			case 'layout3':
			$template = 'portfolio-isotope-3';
			break;
			case 'layout2':
			$template = 'portfolio-isotope-2';
			break;
			default:
			$template = 'portfolio-isotope-1';
			break;
		}
