...
function saasland_register_required_plugins() {
	...
	$plugins = array(
        ...
        array(
            ...
            'source'             => 'https://saasland.droitlab.com/downloadfile/saasland-core_4.1.9.zip', // The plugin sources.
        ...
        array(
            ...
            'source'             => 'https://wpplugin.droitthemes.net/common/advanced-custom-fields-pro.zip', // The plugin sources.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ...
        array(
            ...
            'source'             => 'https://wpplugin.droitthemes.net/common/droit-elementor-templating.zip', // The plugin sources.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ...
        array(
            ...
            'source'             => 'https://wpplugin.droitthemes.net/common/revslider.zip', // The plugin sources.
