...
if ( $purchase_code_status == 'valid' ) :
    ...
    function saasland_demo_import_files() {
        return array (
            ...
            array(
                ...
                'import_file_url'              => 'https://saasland.droitlab.com/demofile/furnitures/contents.xml',
                'import_widget_file_url'       => 'https://saasland.droitlab.com/demofile/furnitures/widgets.wie',
                'import_notice'                => __( 'All other pages will not imported with this Homepage.', 'saasland' ),
                'preview_url'                  => 'https://saaslandwp.com/demo/furniture/',
                'categories'                   => array ( esc_html__( 'New', 'saasland' ), esc_html__( 'eCommerce', 'saasland' ) ),
                'import_redux'           => array (
                    array(
                        'file_url'   => 'https://saasland.droitlab.com/demofile/furnitures/theme-settings.json',
            ...
            array(
                ...
                'import_file_url'              => 'https://saasland.droitlab.com/demofile/ecommerce/contents.xml',
                'import_widget_file_url'       => 'https://saasland.droitlab.com/demofile/commerce/widgets.wie',
                'import_notice'                => __( 'All other pages will not imported with this Homepage.', 'saasland' ),
                'preview_url'                  => 'https://saaslandwp.com/demo/ecommerce/',
                'categories'                   => array ( esc_html__( 'New', 'saasland' ), esc_html__( 'eCommerce', 'saasland' ) ),
                'import_redux'           => array (
                    array(
                        'file_url'   => 'https://saasland.droitlab.com/demofile/commerce/theme-settings.json',
                        'option_name' => 'saasland_opt',
                    ),
                ),
            ),
            ...
            array(
                ...
                'import_file_url'              => 'https://saasland.droitlab.com/demofile/Leadcapture/contents.xml',
                'import_widget_file_url'       => 'https://saasland.droitlab.com/demofile/Leadcapture/widgets.wie',
                'import_notice'                => __( 'All other pages will not imported with this Homepage.', 'saasland' ),
                'preview_url'                  => 'https://saaslandwp.com/demo/lead-capture/',
                'categories'                   => array ( esc_html__( 'New', 'saasland' ), esc_html__( 'Marketing', 'saasland' ) ),
                'import_redux'           => array (
                    array(
                        'file_url'   => 'https://saasland.droitlab.com/demofile/Leadcapture/theme-settings.json',
                        'option_name' => 'saasland_opt',
                    ),
                ),
            ),
            ...
            array(
                ...
                'import_file_url'              => 'https://saasland.droitlab.com/demofile/news/contents.xml',
                'import_widget_file_url'       => 'https://saasland.droitlab.com/demofile/news/widgets.wie',
                'import_notice'                => __( 'All other pages will not imported with this Homepage.', 'saasland' ),
                'preview_url'                  => 'https://saaslandwp.com/demo/news/',
                'categories'                   => array ( esc_html__( 'New', 'saasland' ), esc_html__( 'Agency', 'saasland' ) ),
                'import_redux'           => array (
                    array(
                        'file_url'   => 'https://saasland.droitlab.com/demofile/news/theme-settings.json',
                        'option_name' => 'saasland_opt',
                    ),
                ),
            ),
            ...
            array(
                ...
                'import_file_url'              => 'https://saasland.droitlab.com/demofile/event/contents.xml',
                'import_widget_file_url'       => 'https://saasland.droitlab.com/demofile/event/widgets.wie',
                'import_notice'                => __( 'All other pages will not imported with this Homepage.', 'saasland' ),
                'preview_url'                  => 'https://saaslandwp.com/demo/event/',
                'categories'                   => array ( esc_html__( 'New', 'saasland' ), esc_html__( 'Portfolio', 'saasland' ) ),
                'import_redux'           => array (
                    array(
                        'file_url'   => 'https://saasland.droitlab.com/demofile/event/theme-settings.json',
                        'option_name' => 'saasland_opt',
                    ),
                ),
            ),
            ...
            array(
                ...
                'import_file_url'              => 'https://saasland.droitlab.com/demofile/travel/contents.xml',
                'import_widget_file_url'       => 'https://saasland.droitlab.com/demofile/travel/widgets.wie',
                'import_notice'                => __( 'All other pages will not imported with this Homepage.', 'saasland' ),
                'preview_url'                  => 'https://saaslandwp.com/demo/travel-lifestyle/',
                'categories'                   => array ( esc_html__( 'New', 'saasland' ), esc_html__( 'Agency', 'saasland' ) ),
                'import_redux'           => array (
                    array(
                        'file_url'   => 'https://saasland.droitlab.com/demofile/travel/theme-settings.json',
                        'option_name' => 'saasland_opt',
                    ),
                ),
            ),
    ...
    function saasland_demo_after_import_setup($selected_import) {
        ...
        if ( 'Furniture E-commerce' == $selected_import['import_file_name'] ) {
            $front_page_id = get_page_by_title( 'Furniture Store' );
        }

        if ( 'E-commerce' == $selected_import['import_file_name'] ) {
            $front_page_id = get_page_by_title( 'E-Commerce' );
        }
        ...
        if ( 'News Magazine' == $selected_import['import_file_name'] ) {
            $front_page_id = get_page_by_title( 'News Magazine' );
        }
